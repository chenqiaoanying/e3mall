...
<div class="slide_show" id="slide_show">
    ...
    <div class="indexbg" id="indexbg">
        <dl style="left: -1903px;">
            <dd style="width: 1903px; background: rgb(20, 16, 13);"/>
            <dd style="width: 1903px; background: rgb(119, 96, 86);"/>
            <dd style="width: 1903px; background: rgb(17, 12, 55);"/>
            <dd style="width: 1903px; background: rgb(239, 244, 248);"/>
            <dd style="width: 1903px; background: rgb(231, 32, 37);"/>
            <dd style="width: 1903px; background: rgb(128, 29, 92);"/>
            <dd style="width: 1903px; background: rgb(117, 144, 1);"/>
            <dd style="width: 1903px; background: rgb(253, 213, 29);"/>
        </dl>
    </div>
</div>
<!----row1 end------->
